...
#include"Personne.h"
using namespace std;
void print_map(unordered_map<string, Personne> Map) {
    for (auto it : Map)
    {
...
int main()
{
    ...
    Personne P1("chaimae", "mohammedia", "061111111");
    Personne P3("aymen", "mohammedia", "066655555");
    ...
    cout << "\nEntrer le nom pour recuperer son adresse et son telephone : ";
    cin >> nom;
    bool res = recuperer(Map,nom, adresse, telephone);
    if (res == true)
        cout << endl << "Les infos de "<<nom<<endl<<"Adresse = " << adresse << "\nTelephone = " << telephone<<endl;
    else
        cout <<endl<<nom <<" ne trouve pas dans le Map" << endl;

    cout << "\n\naffichage de map ordonnée :" << endl;
